...
class About extends React.Component {
    getAbout () {
                        ...
                        <div className="row">
                            ...
                            <div className="col-md-4" style={{padding: '0', overflow: 'hidden'}}>
                                <div style={{height: '300px', margin: '0', marginTop: '15px', overflow: 'hidden'}}>
                                    ...
                                    <div id="2-img" className="img-card" style={{height: '300px', backgroundImage: 'url(' + fam + ')'}}></div>
                                    <div id="3-img" className="img-card" style={{height: '300px', backgroundImage: 'url(' + josh + ')'}}></div>
                                    <div id="4-img" className="img-card" style={{height: '300px', backgroundImage: 'url(' + chewie + ')'}}></div>
                                    <div id="5-img" className="img-card" style={{height: '300px', backgroundImage: 'url(' + lulu + ')'}}></div>
        ...
        return(
            <div id="about" style={{visibility: 'hidden', paddingTop: '100px', display: 'none'}}>
